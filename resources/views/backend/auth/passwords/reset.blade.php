    ...
    <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
        ...
        <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
            ...
            <div class="d-flex flex-stack py-2">
                ...
                <!--begin::Sign Up link-->
                <div class="m-0">
                    <span class="text-gray-500 fw-bold fs-5 me-2" data-kt-translate="new-password-head-desc">Remembered your password ?</span>
                    <a href="{{ route('login') }}" class="link-primary fw-bold fs-5" data-kt-translate="new-password-head-link">Sign In</a>
                </div>
                <!--end::Sign Up link=-->
            </div>
            <!--end::Header-->
            ...
            <div class="py-20">
                <!--begin::Form-->
                <form class="form w-100" method="post" novalidate="novalidate" id="kt_new_password_formmm" data-kt-redirect-url="{{ route('dashboard') }}" action="{{ route('password.update') }}">
                    @csrf
                    <!--begin::Heading-->
                    <div class="text-start mb-10">
                        ...
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="text-gray-500 fw-semibold fs-6" data-kt-translate="new-password-desc">You're reseting password for {{$email}}</div>
                        <!--end::Link-->
                        <input type="hidden" name="email" value="{{$email}}">
                    </div>
                    <!--end::Heading-->
                    <div class="fv-row mb-10">
                        <input class="form-control form-control-lg form-control-solid" type="text" placeholder="OTP" name="otp" autocomplete="off" />
                        @error('otp')
                    ...
                    <div class="mb-10 fv-row" data-kt-password-meter="true">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="position-relative mb-3">
                                <input class="form-control form-control-lg form-control-solid" type="password" placeholder="Password" name="password" required autocomplete="off" data-kt-translate="new-password-input-password" />
                    ...
                    <!--begin::Input group=-->
                    <div class="fv-row mb-10">
                        <input id="password-confirm" class="form-control form-control-lg form-control-solid" type="password" placeholder="Confirm Password" name="password_confirmation" required autocomplete="off" data-kt-translate="new-password-confirm-password" />
                    </div>
                    <!--end::Input group=-->
                    <!--begin::Actions-->
...
@push('scripts')
    ...
    <script src="{{asset('frontend/js/custom/authentication/reset-password/new-password.js')}}"></script>
    <script src="{{asset('frontend/js/custom/authentication/sign-in/i18n.js')}}"></script>
