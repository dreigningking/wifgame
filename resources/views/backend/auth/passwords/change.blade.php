...
<div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div class="d-flex flex-column flex-column-fluid flex-center w-lg-50 p-10">
        ...
        <div class="d-flex justify-content-between flex-column-fluid flex-column w-100 mw-450px">
            ...
            <div class="py-20">
                <!--begin::Form-->
                <form class="form w-100" method="post" novalidate="novalidate" data-kt-redirect-url="{{ route('dashboard') }}" action="{{ route('password.change') }}">
                    @csrf
                    <!--begin::Heading-->
                    <div class="text-start mb-10">
                        ...
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="text-gray-500 fw-semibold fs-6" data-kt-translate="new-password-desc">You're required to change your password</div>
