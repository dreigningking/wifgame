    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <!--begin::Form-->
                <form action="{{ route('admin.posts.store') }}" method="post" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data">@csrf
                    <!--begin::Aside column-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="title" maxlength="80" class="form-control mb-2" placeholder="Article title" value="" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Editor-->
                                        <textarea name="summary" class="form-control mb-2"></textarea>
                                        <!--end::Editor-->
                                        <!--begin::Description-->
                                    ...
                                    <div>
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Editor-->
                                        <textarea name="body" class="summernote-editor min-h-200px mb-2"></textarea>
                                        <!--end::Editor-->
                                        <!--begin::Description-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <input type="text" name="meta_description" maxlength="140" id="meta_description" class="form-control mb-2" />
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <input type="text" name="main_keyphrase" maxlength="50" id="main_keyphrase" class="form-control mb-2" />
                                    ...
                                    <div class="fv-row mb-5">
                                        ...
                                        <input type="text" name="related_keyphrases" maxlength="140" id="related_keyphrases" class="form-control mb-2" />
